...
$lang = array(
    ...
    'request_tainting' => '<h4>哎呀，别再扒小堂的衣服啦 = =#</h4><p>您当前的访问请求当中含有非法字符，已经被系统拒绝</p>',
    'error_not_file' => '<h4>噢！小堂或许正在写这份作业？！</h4><p>当前文件已丢失： <strong>{file}</strong></p>',
    'error_not_template' => '<h4>小堂忘记画这个模板了，怎么办？！</h4><p>当前模板已丢失： <strong>{file}</strong></p>',
    ...
    'backtrace' => '运行信息',
    'error_end_message' => '/* 已经将此出错信息详细记录, 由此给您带来的访问不便我们深感歉意 */',
